...
2022年是外汇干预效力的最近一次大型现实检验。

背景：美联储快速加息（从0到5%），日本央行坚持超宽松货币政策（接近零利率）。利率差暴扩 → 大量资金从日本流出 → 日元从年初的115快速贬值到峰值的151.9，全年贬值约32%。

日本财务省/日本银行多次入市干预——2022年全年花费约9万亿日元（约650亿美元）试图阻止日元下跌。结果：每次干预后日元短暂反弹几个百分点，然后继续下跌。最终，真正让日元止跌的不是干预，而是美联储结束加息周期和日本央行开始调整超宽松政策。
