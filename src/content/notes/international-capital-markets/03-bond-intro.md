...
你终于从"隔夜利率"走到了"长期债券"的世界。这节课的任务是把债券这个**全球最大的资产类别**讲清楚——比股票大得多、交易方式完全不同、和货币市场有什么关系、怎么报价、怎么交易、怎么清算。
...
其中 $C$ 是每期票息，$y$ 是**到期收益率**（YTM），$n$ 是剩余期数。
...
**SVB 破产的核心教训**（2023 年）：硅谷银行持有大量长期国债和 MBS。2022–2023 年利率飙升后，这些债券**浮亏数百亿美元**。当存款人开始挤兑，银行被迫卖出这些债券**实现**了损失——破产。
...
和股票不同，大多数债券**不在交易所上市**——而是在**场外（over-the-counter, OTC）** 通过交易商（dealers）买卖：
- 交易员报买价（bid）和卖价（ask）
- 差额就是 dealer 的利润
