...
- **YouTube - "Heckscher-Ohlin Model Explained" (Khan Academy 或类似频道)**：搜索 "Heckscher Ohlin model explained"，Khan Academy 和 Economics Explained 都有直观演示，建议先看视频再深入数学。
- **YouTube - "Who Gains from Trade? The Stolper-Samuelson Theorem"**：搜索 "Stolper Samuelson theorem trade income distribution"，帮助建立从要素丰裕度到政治联盟的完整直觉。
