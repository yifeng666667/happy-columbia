...
Session 1 的李嘉图模型回答了"比较优势存在"这一事实，但没有告诉我们比较优势**从哪里来**——为什么英国擅长布料、葡萄牙擅长葡萄酒？**赫克歇尔-俄林定理（Heckscher-Ohlin theorem，以下简称 H-O 定理）**提供了一个更深的答案：比较优势来自生产要素的相对丰裕程度（**要素禀赋，factor endowments**）。这个框架的力量在于，它不只预测贸易模式，还预测了贸易对国内收入分配的影响——这才是贸易政治上最敏感的部分。

## 一、H-O 定理：要素禀赋决定贸易模式

![中国深圳制造业工厂——劳动力禀赋与贸易模式的现实](https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=900&q=80)
...
H-O 定理比李嘉图模型更有解释力，因为它给出了比较优势的**内生来源**，而不是直接假定它存在。但它的预测也经常在现实中偏差很大（后面会讲），这本身就是一个很重要的知识点——一个理论的失灵，往往比它的成功更能教给我们东西。
...
![美国农业大平原——土地要素丰裕造就的全球竞争力](https://images.unsplash.com/photo-1459257831348-f0cdd359235f?auto=format&fit=crop&w=900&q=80)
